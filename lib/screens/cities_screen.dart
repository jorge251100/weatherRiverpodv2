    ...
    return Container(
      decoration: BoxDecoration(
        gradient: LinearGradient(
          ...
          colors: <Color>[
            const Color.fromRGBO(37, 42, 96, 1),
            const Color.fromRGBO(30, 29, 60, 1),
          ],
        ),
      ),
                            ...
                            child: Container(
                              decoration: BoxDecoration(
                                  gradient: LinearGradient(
                                    ...
                                    colors: <Color>[
                                      const Color.fromRGBO(48, 38, 124, 1),
                                      const Color.fromRGBO(55, 54, 88, 1),
                                    ],
                                  ),
        ...
        floatingActionButton: Row(
          ...
          children: [
            FloatingActionButton(
                  ...
                  builder: (context) {
                    ...
                    return AlertDialog(
                      ...
                      content: TextField(
                        ...
                        decoration: InputDecoration(hintText: 'Enter city name', hintStyle: TextStyle(color: Colors.white)),
              ...
              child: Icon(Icons.add, color: Color.fromRGBO(30, 29, 60, 1),),
            ),
          ],
        ),
      ),
